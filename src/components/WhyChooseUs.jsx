...
const features = [
  {
    Icon: Heart, number: '01', title: 'Made with Care',
    ...
    hoverBorder: 'hover:border-rose-200', hoverBg: 'hover:bg-rose-50/50',
  },
  {
    Icon: Sun, number: '02', title: 'Freshly Prepared Daily',
    ...
    hoverBorder: 'hover:border-orange-200', hoverBg: 'hover:bg-orange-50/50',
  },
  {
    Icon: IndianRupee, number: '03', title: 'Honestly Affordable',
    description: 'Restaurant-quality home food at prices that make sense. No hidden charges, no delivery surprises.',
    iconBg: 'bg-green-100', iconColor: 'text-green-600',
    hoverBorder: 'hover:border-green-200', hoverBg: 'hover:bg-green-50/50',
  },
  {
    Icon: Clock4, number: '04', title: 'On-Time Delivery',
    ...
    hoverBorder: 'hover:border-blue-200', hoverBg: 'hover:bg-blue-50/50',
  },
]
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: 'radial-gradient(ellipse at 80% 50%, rgba(251,191,36,0.07) 0%, transparent 60%)' }}
      />

      <div className="relative max-w-6xl mx-auto px-5 sm:px-8 lg:px-12">
        {/* Header */}
        <div className="mb-16">
          <ScrollReveal variant="slideRight" className="flex items-center gap-3 mb-5">
          ...
          <h2 className="font-display text-4xl sm:text-5xl font-light text-espresso leading-tight mb-4">
            <TextReveal text="Food that feels like" className="block" delay={0} />
            <TextReveal text="home" className="block text-gradient-warm italic font-semibold" delay={0.15} />
          </h2>

          <ScrollReveal variant="fadeUp" delay={0.3}>
            <p className="font-body text-base text-warm-gray max-w-md">
        ...
        <div ref={ref} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {features.map(({ Icon, number, title, description, iconBg, iconColor, hoverBorder, hoverBg }, i) => (
            ...
            >
              ...
              <h3 className="font-display font-semibold text-xl text-espresso mb-2 leading-tight">{title}</h3>
              ...
              <motion.div
                ...
                className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-orange-300 to-orange-500 origin-left"
              />
            </motion.div>
          ))}
        </div>
