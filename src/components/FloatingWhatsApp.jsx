...
export default function FloatingWhatsApp() {
  ...
  useEffect(() => {
    const t = setTimeout(() => { if (!dismissed) setShowTooltip(true) }, 3500)
  ...
  const dismiss = () => { setShowTooltip(false); setDismissed(true) }

  return (
    <div className="fixed bottom-6 right-5 sm:right-7 z-50 flex flex-col items-end gap-3">
      {/* Tooltip */}
      <AnimatePresence>
